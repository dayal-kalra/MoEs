...
models = {'moegpt': lms.MoEGPT, 'moegpt_mup': lms.MoEGPT_muP, 'pregpt': lms.PreLNGPT, 'pregpts': lms.PreLNGPTs, 'postgpt':lms.PostLNGPT}
...
parser.add_argument('--model_name', type = str, default = 'moegpt') 
